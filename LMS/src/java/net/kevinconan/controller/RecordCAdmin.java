...
import net.kevinconan.model.AdminBean;
import net.kevinconan.model.RecordBO;

/**
 *
 * @author Kevin
 */
@WebServlet(name = "RecordCAdmin", urlPatterns = {"/RecordCAdmin"})
public class RecordCAdmin extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("AdminRecords.jsp?viewType=" + viewType + "&pageNow=" + pageNow + "&pageCount=" + pageCount).forward(request, response);
